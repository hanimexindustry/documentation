...
#. Select :guilabel:`Add/New`, select :guilabel:`Tera Software Limited` as your GSP Name, and create
...
Once the invoice is validated and :guilabel:`SEND E-WAYBILL` is clicked, a confirmation message will be
